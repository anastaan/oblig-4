class Lege implements Comparable<Lege>{
  ...
  public Lege(String navn) throws NullPointerException{
  ...
  public HvitResept skrivHvitResept(Legemiddel legemiddel, Pasient pasient, int reit) throws UlovligUtskrift, NullPointerException{
    ...
    pasient.leggTilNyResept(nyResept);
    return nyResept;
  }
  ...
  public MillitaerResept skrivMillitaerResept(Legemiddel legemiddel, Pasient pasient, int reit) throws UlovligUtskrift, NullPointerException{
    // Dersom legen ikke er Spesialist og legemiddelet er Narkotisk, skal det kastes et unntak (UlovligUtskrift).
    if (legemiddel instanceof Narkotisk && this instanceof Spesialist == false) throw new UlovligUtskrift(this, legemiddel);
  ...
  public PResept skrivPResept(Legemiddel legemiddel, Pasient pasient) throws UlovligUtskrift, NullPointerException{
    // Dersom legen ikke er Spesialist og legemiddelet er Narkotisk, skal det kastes et unntak (UlovligUtskrift).
    if (legemiddel instanceof Narkotisk && this instanceof Spesialist == false) throw new UlovligUtskrift(this, legemiddel);
  ...
  public BlaaResept skrivBlaaResept(Legemiddel legemiddel, Pasient pasient, int reit) throws UlovligUtskrift, NullPointerException{
    // Dersom legen ikke er Spesialist og legemiddelet er Narkotisk, skal det kastes et unntak (UlovligUtskrift).
    if (legemiddel instanceof Narkotisk && this instanceof Spesialist == false) throw new UlovligUtskrift(this, legemiddel);
